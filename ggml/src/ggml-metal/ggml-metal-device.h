...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_ext_tq3_0_cached(ggml_metal_library_t lib, enum ggml_type tsrc0, enum ggml_type tsrc1, int nsg, int nxpsg, int r1ptg, bool is_float4x4);
