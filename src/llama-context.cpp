...
llama_context * llama_init_from_model(
    ...
    // Handle both AUTO and DISABLED since TQ3_0 quantized V cache requires FA.
    if ((params.flash_attn_type == LLAMA_FLASH_ATTN_TYPE_AUTO ||
         params.flash_attn_type == LLAMA_FLASH_ATTN_TYPE_DISABLED) && params.type_k == GGML_TYPE_TQ3_0) {
        if (ggml_is_quantized(params.type_v)) {
